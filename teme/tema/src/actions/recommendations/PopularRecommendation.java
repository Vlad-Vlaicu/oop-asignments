...
public class PopularRecommendation extends Action {
    ...
    public String execute() {
        ...
        for(Map.Entry e : entries){
            Optional<Movie> movieBox = Optional.ofNullable(movieService.findMovieByTitle((String) e.getKey()));
            Optional<Show> showBox = Optional.ofNullable(showService.findShowByTitle((String) e.getKey()));
